...
type Role struct {
	...
	RulesChecked string `gorm:"column:rules_checked;not null;comment:权限树选中的字节点ID" json:"rules_checked"`     // 权限树选中的字节点ID
	...
	IsAuto       int32  `gorm:"column:is_auto;not null;comment:是否为系统自动创建" json:"is_auto"`                   // 是否为系统自动创建
}
