<template>
	<div class="login_bg">
		<div class="login_adv" style="background-image: url(/admin/img/auth_banner.jpg);">
			<div class="login_adv__title">
<!--				<h2>{{ $CONFIG.APP_NAME }}</h2>-->
				<h4>{{ $t('login.slogan') }}</h4>
				<p>{{ $t('login.describe') }}</p>
				<div>
					<span title="宜宾科佑网络科技有限责任公司">
						<img src="/admin/img/support/keyou.png" style="width: 35px;border-radius: 3px" alt="">
					</span>
					<span>
						<el-icon class="add"><el-icon-plus /></el-icon>
					</span>
					<span>
						<img src="/admin/img/support/tencent.png" style="width: 35px;border-radius: 3px" alt="">
					</span>
				</div>
			</div>
...
<style scoped>
	...
	.login_adv__mask {position: absolute;top:0px;left:0px;right: 0px;bottom: 0px;background: rgba(0,0,0,0.2);z-index: 1;}
